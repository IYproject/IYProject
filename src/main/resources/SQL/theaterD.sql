...
--공연시간 안내(td_tinfo),메인포스터(td_mainposter),게시판 내용(td_detailposter),1회 시간(td_ticketinginfo),
--게시글 승인 확인(td_check), 승인요청 날짜(td_signUp_date), 시도(td_location)
update basictheater set td_agegrade='12세 이용 관람가' where td_no=40 or td_no=41;
...
ticketingInfo, basictheater where ticketingInfo.td_no = basictheater.td_no) where td_title ='가족 어린이 뮤지컬 [공주와 개구리 ~ 개구리 왕자]' and td_location='서울특별시' and 
...
where td_no =39 and td_runtime='2020-10-25 11:00~11:50'
